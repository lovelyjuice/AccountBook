...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.searchEdit.setMinimumSize(QtCore.QSize(150, 25))
        font = QtGui.QFont()
        ...
        Form.setTabOrder(self.searchEdit, self.tabWidget)
        Form.setTabOrder(self.tabWidget, self.mbrCBox)
        Form.setTabOrder(self.mbrCBox, self.typeCBox)
        Form.setTabOrder(self.typeCBox, self.startDateEdt)
        Form.setTabOrder(self.startDateEdt, self.endDateEdt)
        Form.setTabOrder(self.endDateEdt, self.filtrateBtn)
        Form.setTabOrder(self.filtrateBtn, self.revertBtn)
        Form.setTabOrder(self.revertBtn, self.chargeTable)
        Form.setTabOrder(self.chargeTable, self.chargeBtn)
        Form.setTabOrder(self.chargeBtn, self.delChargeBtn)
        Form.setTabOrder(self.delChargeBtn, self.memberTable)
        Form.setTabOrder(self.memberTable, self.addMbrBtn)
        Form.setTabOrder(self.addMbrBtn, self.delMbrBtn)
        Form.setTabOrder(self.delMbrBtn, self.typeList)
        Form.setTabOrder(self.typeList, self.addTypeBtn)
        Form.setTabOrder(self.addTypeBtn, self.delTypeBtn)
        Form.setTabOrder(self.delTypeBtn, self.pushButton)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "家庭账本"))
        ...
        self.chargeBtn.setToolTip(_translate("Form", "记一笔帐"))
        self.chargeBtn.setStatusTip(_translate("Form", "记一笔帐"))
        self.chargeBtn.setText(_translate("Form", "+"))
        self.delChargeBtn.setToolTip(_translate("Form", "删除记录"))
        self.delChargeBtn.setStatusTip(_translate("Form", "删除记录"))
